...
[~,outclass,Z,f1,f2]= ftsvmclass(ftsvm_struct,test_Traindata);
...
colorbar
hold off
line=['Fuzzy membership distribution of CDFTSVM  with ' num2str(ftsvm_struct.Parameter.ker),' kernel' ];
...
set(h4,'EdgeColor','w');
line=['Fuzzy membership value of CDFTSVM  with ' num2str(ftsvm_struct.Parameter.ker),' kernel' ];
title(line,'FontSize',12);
%%
figure;
clf;
...
line=['Visualization of',' CDFTSVM classification with ' num2str(ftsvm_struct.Parameter.ker),' kernel' ];
title(line,'FontSize',12);
end
